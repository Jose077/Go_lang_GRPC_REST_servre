...
func (x *FibonacciRequest) Reset() {
	*x = FibonacciRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_math_message_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FibonacciRequest) Descriptor() ([]byte, []int) {
	return file_proto_math_message_proto_rawDescGZIP(), []int{3}
}
...
func (x *FibonacciResponse) Reset() {
	*x = FibonacciResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_math_message_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FibonacciResponse) Descriptor() ([]byte, []int) {
	return file_proto_math_message_proto_rawDescGZIP(), []int{4}
}
...
var file_proto_math_message_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x20, 0x0a, 0x10, 0x46, 0x69, 0x62, 0x6f, 0x6e, 0x61, 0x63,
	0x63, 0x69, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0c, 0x0a, 0x01, 0x6e, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x05, 0x52, 0x01, 0x6e, 0x22, 0x2b, 0x0a, 0x11, 0x46, 0x69, 0x62, 0x6f, 0x6e,
	...
	0x73, 0x75, 0x6c, 0x74, 0x32, 0x97, 0x01, 0x0a, 0x0b, 0x4d, 0x61, 0x74, 0x68, 0x53, 0x65, 0x72,
	...
	0x22, 0x00, 0x12, 0x4a, 0x0a, 0x09, 0x46, 0x69, 0x62, 0x6f, 0x6e, 0x61, 0x63, 0x63, 0x69, 0x12,
	0x1b, 0x2e, 0x66, 0x75, 0x6c, 0x6c, 0x63, 0x79, 0x63, 0x6c, 0x65, 0x2e, 0x46, 0x69, 0x62, 0x6f,
	0x6e, 0x61, 0x63, 0x63, 0x69, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1c, 0x2e, 0x66,
	0x75, 0x6c, 0x6c, 0x63, 0x79, 0x63, 0x6c, 0x65, 0x2e, 0x46, 0x69, 0x62, 0x6f, 0x6e, 0x61, 0x63,
	0x63, 0x69, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x42, 0x05,
...
var file_proto_math_message_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_proto_math_message_proto_goTypes = []interface{}{
	...
	(*FibonacciRequest)(nil),  // 3: fullcycle.FibonacciRequest
	(*FibonacciResponse)(nil), // 4: fullcycle.FibonacciResponse
}
var file_proto_math_message_proto_depIdxs = []int32{
	...
	3, // 2: fullcycle.MathService.Fibonacci:input_type -> fullcycle.FibonacciRequest
	2, // 3: fullcycle.MathService.Sum:output_type -> fullcycle.NewSumResponse
	4, // 4: fullcycle.MathService.Fibonacci:output_type -> fullcycle.FibonacciResponse
...
func file_proto_math_message_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_math_message_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_math_message_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
